...
$Id: accessors.py,v 1.1 2004/11/30 17:33:40 guido Exp $
"""
from z3locales.interface import providedBy, implementedBy
from z3locales.interface.interface import Method
