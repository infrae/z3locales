...
$Id: _field.py,v 1.1 2004/11/30 17:33:40 guido Exp $
"""
import warnings
import re
...
from z3locales.interface import classImplements, implements, directlyProvides
from z3locales.interface.interfaces import IInterface, IMethod

from z3locales.schema.interfaces import IField
from z3locales.schema.interfaces import IMinMaxLen, IText, ITextLine
from z3locales.schema.interfaces import ISourceText
from z3locales.schema.interfaces import IInterfaceField
from z3locales.schema.interfaces import IBytes, IASCII, IBytesLine
from z3locales.schema.interfaces import IBool, IInt, IFloat, IDatetime
from z3locales.schema.interfaces import IChoice, ITuple, IList, ISet, IDict
from z3locales.schema.interfaces import IPassword, IObject, IDate
from z3locales.schema.interfaces import IURI, IId, IFromUnicode
from z3locales.schema.interfaces import IVocabulary

from z3locales.schema.interfaces import ValidationError, InvalidValue
from z3locales.schema.interfaces import WrongType, WrongContainedType, NotUnique
from z3locales.schema.interfaces import SchemaNotProvided, SchemaNotFullyImplemented
from z3locales.schema.interfaces import InvalidURI, InvalidId, InvalidDottedName
from z3locales.schema.interfaces import ConstraintNotSatisfied
from z3locales.schema.interfaces import Unbound

from z3locales.schema._bootstrapfields import Field, Container, Iterable, Orderable
from z3locales.schema._bootstrapfields import MinMaxLen
from z3locales.schema._bootstrapfields import Text, TextLine, Bool, Int, Password
from z3locales.schema._bootstrapfields import MinMaxLen, ValidatedProperty
from z3locales.schema.fieldproperty import FieldProperty
from z3locales.schema.vocabulary import getVocabularyRegistry
from z3locales.schema.vocabulary import SimpleTerm, SimpleVocabulary
...
class Choice(Field):
    ...
    def bind(self, object):
        """See z3locales.schema._bootstrapinterfaces.IField."""
...
class Id(BytesLine):
    ...
    def _validate(self, value):
        ...
        >>> id.validate("z3locales.app.content")
        >>> id.validate("z3locales.app.content/a")
        Traceback (most recent call last):
        ...
        InvalidId: z3locales.app.content/a
        >>> id.validate("http://z3locales.app.content x y")
        Traceback (most recent call last):
        ...
        InvalidId: http://z3locales.app.content x y
        """
