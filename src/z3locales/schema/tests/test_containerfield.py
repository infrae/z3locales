...
$Id: test_containerfield.py,v 1.1 2004/11/30 17:33:41 guido Exp $
"""
from UserDict import UserDict
from unittest import main, makeSuite
from z3locales.schema import Container
from z3locales.schema.interfaces import RequiredMissing, NotAContainer
