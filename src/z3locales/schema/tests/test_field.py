...
$Id: test_field.py,v 1.1 2004/11/30 17:33:41 guido Exp $
"""
from unittest import TestCase, TestSuite, main, makeSuite
from z3locales.schema import Field, Text, Int
from z3locales.schema.interfaces import ValidationError, RequiredMissing
...
def test_suite():
    return TestSuite((
        ...
        DocTestSuite("z3locales.schema._field"),
        DocTestSuite("z3locales.schema._bootstrapfields"),
        ))
