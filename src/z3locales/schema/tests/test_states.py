...
$Id: test_states.py,v 1.1 2004/11/30 17:33:41 guido Exp $
"""
import unittest

from z3locales.interface import Interface
from z3locales.interface.verify import verifyObject

from z3locales.schema import vocabulary
from z3locales.schema import Choice
from z3locales.schema.interfaces import IVocabulary
from z3locales.schema.tests import states
