...
$Id: vocabulary.py,v 1.1 2004/11/30 17:33:39 guido Exp $
"""
from z3locales.interface.declarations import directlyProvides, implements
from z3locales.schema.interfaces import ValidationError
from z3locales.schema.interfaces import IVocabularyRegistry
from z3locales.schema.interfaces import IVocabulary, IVocabularyTokenized
from z3locales.schema.interfaces import ITokenizedTerm, ITitledTokenizedTerm
...
class SimpleVocabulary(object):
    ...
    def __contains__(self, value):
        """See z3locales.schema.interfaces.IBaseVocabulary"""
        try:
    ...
    def getTermByToken(self, token):
        """See z3locales.schema.interfaces.IVocabularyTokenized"""
        try:
    ...
    def __iter__(self):
        """See z3locales.schema.interfaces.IIterableVocabulary"""
...
class VocabularyRegistry(object):
    ...
    def get(self, object, name):
        """See z3locales.schema.interfaces.IVocabularyRegistry""" 
        try:
...
try:
    from z3locales.testing.cleanup import addCleanUp
except ImportError:
