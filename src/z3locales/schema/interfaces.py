...
$Id: interfaces.py,v 1.1 2004/11/30 17:33:39 guido Exp $
"""

from z3locales.interface import Interface, Attribute
from z3locales.schema._bootstrapfields import Field, Text, TextLine, Bool, Int
from z3locales.schema._bootstrapfields import Container, Iterable

from z3locales.i18nmessageid import MessageIDFactory
_ = MessageIDFactory("z3locales")

# Import from _bootstrapinterfaces only because other packages will expect
# to find these interfaces here.
from z3locales.schema._bootstrapinterfaces import StopValidation, ValidationError
from z3locales.schema._bootstrapinterfaces import IFromUnicode
from z3locales.schema._bootstrapinterfaces import RequiredMissing, WrongType
from z3locales.schema._bootstrapinterfaces import ConstraintNotSatisfied
from z3locales.schema._bootstrapinterfaces import NotAContainer, NotAnIterator
from z3locales.schema._bootstrapinterfaces import TooSmall, TooBig
from z3locales.schema._bootstrapinterfaces import TooShort, TooLong
from z3locales.schema._bootstrapinterfaces import InvalidValue
