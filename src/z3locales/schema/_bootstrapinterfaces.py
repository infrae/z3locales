...
$Id: _bootstrapinterfaces.py,v 1.1 2004/11/30 17:33:40 guido Exp $
"""
...
class ValidationError(z3locales.interface.Invalid):
...
class IFromUnicode(z3locales.interface.Interface):
