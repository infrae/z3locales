...
$Id: test_interface.py,v 1.1 2004/11/30 17:33:39 guido Exp $
"""
import unittest
from z3locales.testing.doctestunit import DocTestSuite
from z3locales.interface.tests.unitfixtures import *  # hehehe
from z3locales.interface.exceptions import BrokenImplementation, Invalid
from z3locales.interface import implementedBy, providedBy
from z3locales.interface import Interface, directlyProvides, Attribute
...
class InterfaceTests(unittest.TestCase):
    ...
    def testVerifyImplementation(self):
        from z3locales.interface.verify import verifyClass
    ...
    def testIssue228(self):
        # Test for http://collector.z3locales.org/Zope3-dev/228
        class I(Interface):
            "xxx"
        class Bad:
            __providedBy__ = None
...
def test_suite():
    from z3locales.testing import doctest
    suite = unittest.makeSuite(InterfaceTests)
    suite.addTest(doctest.DocTestSuite("z3locales.interface.interface"))
