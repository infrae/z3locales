...
$Id: test_odd_declarations.py,v 1.1 2004/11/30 17:33:38 guido Exp $
"""
import unittest, odd
from z3locales.interface import Interface, implements, implementsOnly
from z3locales.interface import directlyProvides, providedBy, directlyProvidedBy
from z3locales.interface import classImplements, classImplementsOnly, implementedBy
...
# from z3locales.interface import classProvides
