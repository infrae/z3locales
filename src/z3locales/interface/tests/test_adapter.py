...
$Id: test_adapter.py,v 1.1 2004/11/30 17:33:39 guido Exp $
"""
import unittest, doctest
import z3locales.interface
from z3locales.interface.adapter import AdapterRegistry
import z3locales.interface

class IF0(z3locales.interface.Interface):
    pass
class IF1(IF0):
    pass

class IB0(z3locales.interface.Interface):
    pass
class IB1(IB0):
    pass

class IR0(z3locales.interface.Interface):
    pass
class IR1(IR0):
    pass
...
def test_orderwith():
    """
    >>> Interface = z3locales.interface.Interface
    ...
    >>> [value for spec, value in z3locales.interface.adapter.orderwith(bywith)]
...
def test_multi_adapter_w_inherited_and_multiple_registrations():
    ...
    >>> class IX(z3locales.interface.Interface):
    ...    pass
...
def test_suite():
    from z3locales.testing.doctestunit import DocFileSuite
