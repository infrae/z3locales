...
$Id: adapter.py,v 1.1 2004/11/30 17:33:37 guido Exp $
"""
...
import weakref
from z3locales.interface.ro import ro
from z3locales.interface.declarations import providedBy
from z3locales.interface.interface import InterfaceClass, Interface
