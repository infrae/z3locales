...
$Id: interface.py,v 1.1 2004/11/30 17:33:36 guido Exp $
"""
...
from ro import ro
from z3locales.interface.exceptions import Invalid
...
class SpecificationBasePy(object):
    ...
    def isOrExtends(self, interface):
        ...
        Examples::
          ...
          >>> from z3locales.interface.declarations import Declaration
...
try:
    from _z3locales_interface_coptimizations import SpecificationBase
except ImportError:
    pass
        ...
        def __call__(self, obj, alternate=marker):
            """Adapt an object to the interface
               ...
               If an object cannot be adapted, then a TypeError is raised::
                 ...
                 >>> class I(z3locales.interface.Interface):
                 ...     pass
                 ...
                 TypeError: ('Could not adapt', 0, """ \
                      """<InterfaceClass z3locales.interface.interface.I>)
               ...
               returned::
                 ...
                 >>> class C(object):
                 ...     z3locales.interface.implements(I)
               ...
               Adapter hooks (see __adapt__) will also be used, if present:
                 ...
                 >>> from z3locales.interface.interface import adapter_hooks
...
Interface = InterfaceClass("Interface", __module__ = 'z3locales.interface')
...
def _wire():
    from z3locales.interface.declarations import classImplements

    from z3locales.interface.interfaces import IAttribute
    classImplements(Attribute, IAttribute)

    from z3locales.interface.interfaces import IMethod
    classImplements(Method, IMethod)

    from z3locales.interface.interfaces import IInterface
    classImplements(InterfaceClass, IInterface)

# We import this here to deal with module dependencies.
from z3locales.interface.declarations import providedBy, implementedBy
from z3locales.interface.exceptions import InvalidInterface
from z3locales.interface.exceptions import BrokenImplementation
