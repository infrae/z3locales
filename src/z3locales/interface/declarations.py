...
$Id: declarations.py,v 1.1 2004/11/30 17:33:37 guido Exp $
"""
import sys
import weakref
from z3locales.interface.interface import InterfaceClass, Specification
from ro import mergeOrderings, ro
import exceptions
from types import ClassType
from z3locales.interface.advice import addClassAdvisor
    ...
    def get():
        ...
        def get(self, name, default=None):
            """Query for an attribute description
                ...
                >>> class I1(z3locales.interface.Interface):
                ...    a11 = z3locales.interface.Attribute('a11')
                ...    a12 = z3locales.interface.Attribute('a12')
                >>> class I2(z3locales.interface.Interface):
                ...    a21 = z3locales.interface.Attribute('a21')
                ...    a22 = z3locales.interface.Attribute('a22')
                ...    a12 = z3locales.interface.Attribute('a212')
                >>> class I11(I1):
                ...    a11 = z3locales.interface.Attribute('a111')
...
def implementedByFallback(cls):
    ...
    try:
        ...
        # We don't want to depend directly on z3locales.secury in
        # z3locales.interface, but we'll try to make reasonable
...
class Provides(Declaration):  # Really named ProvidesClass
    ...
    __module__ = 'z3locales.interface'
...
# Try to get C base:
try:
    import _z3locales_interface_coptimizations
except ImportError:
    pass
else:
    from _z3locales_interface_coptimizations import ClassProvidesBase
...
try:
    ...
    from _z3locales_interface_coptimizations import implementedBy, providedBy
    from _z3locales_interface_coptimizations import getObjectSpecification
    from _z3locales_interface_coptimizations import ObjectSpecificationDescriptor
