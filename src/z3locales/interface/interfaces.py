...
$Id: interfaces.py,v 1.1 2004/11/30 17:33:37 guido Exp $
"""

from z3locales.interface import Interface
from z3locales.interface.interface import Attribute
...
class ISpecification(Interface):
    ...
    def weakref(callback=None):
        ...
        z3locales.interface package does not require z3locales.security or
        z3locales.proxy, it has to be able to coexist with it.
...
class IInterface(ISpecification, IElement):
    ...
    o You assert that your object implement the interfaces.
      ...
      1. Call z3locales.interface.implements in your class definition.

      2. Call z3locales.interfaces.directlyProvides on your object.

      3. Call 'z3locales.interface.classImplements' to assert that instances
         of a class implement an interface.

         For example::

           from z3locales.interface import classImplements
