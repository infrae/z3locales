...
$Id: format.py,v 1.1 2004/11/30 17:33:09 guido Exp $
"""
import re
import math
import datetime

from z3locales.i18n.interfaces import IDateTimeFormat, INumberFormat
...
class DateTimeFormat(object):
    ...
    def setPattern(self, pattern):
        "See z3locales.i18n.interfaces.IFormat"
        self._pattern = pattern
        self._bin_pattern = parseDateTimePattern(self._pattern,
                                                 self._DATETIMECHARS)
