...
$Id: test_locales.py,v 1.1 2004/11/30 17:33:34 guido Exp $
"""
import os
import datetime
from unittest import TestCase, TestSuite, makeSuite

from z3locales.i18n.interfaces.locales import ILocaleProvider
from z3locales.i18n.locales import locales
from z3locales.i18n.locales.provider import LocaleProvider, LoadLocaleError

import z3locales.i18n
datadir = os.path.join(os.path.dirname(z3locales.i18n.__file__), 'locales', 'data')
