...
$Id: __init__.py,v 1.1 2004/11/30 17:33:10 guido Exp $
"""
import os
...
from z3locales.i18n.interfaces.locales import ILocale
from z3locales.i18n.interfaces.locales import ILocaleDisplayNames, ILocaleDates
from z3locales.i18n.interfaces.locales import ILocaleVersion, ILocaleIdentity
from z3locales.i18n.interfaces.locales import ILocaleTimeZone, ILocaleCalendar
from z3locales.i18n.interfaces.locales import ILocaleCurrency, ILocaleNumbers
from z3locales.i18n.interfaces.locales import ILocaleFormat, ILocaleFormatLength
from z3locales.i18n.format import NumberFormat, DateTimeFormat
from z3locales.i18n.locales.inheritance import \
     AttributeInheritance, InheritingDictionary, NoParentException
from z3locales.i18n.locales.provider import LocaleProvider, LoadLocaleError

# Setup the locale directory
from z3locales import i18n
...
class LocaleIdentity(object):
    ...
    def __repr__(self):
        """See z3locales.i18n.interfaces.ILocaleIdentity
        """
...
class LocaleVersion(object):
    ...
    def __cmp__(self, other):
        "See z3locales.i18n.interfaces.ILocaleVersion"
...
class LocaleDisplayNames(AttributeInheritance):
    ...
    Examples::
      ...
      >>> from z3locales.i18n.locales.tests.test_docstrings import \\
...
class LocaleCalendar(AttributeInheritance):
    ...
    def getMonthNames(self):
        """See z3locales.i18n.interfaces.ILocaleCalendar"""
...
class LocaleDates(AttributeInheritance):
    ...
    Examples::
      ...
      >>> from z3locales.i18n.tests.test_formats import LocaleCalendarStub as Stub
    ...
    def getFormatter(self, category, length=None, name=None,
        ...
        """See z3locales.i18n.interfaces.locales.ILocaleDates"""
...
`    Examples::
    ...
    def getFormatter(self, category, length=None, name=None):
        """See z3locales.i18n.interfaces.locales.ILocaleNumbers"""
...
class Locale(AttributeInheritance):
    ...
    def getInheritedSelf(self):
        """See z3locales.i18n.interfaces.locales.ILocaleInheritance
