...
$Id: test_simpletranslationdomain.py,v 1.1 2004/11/30 17:33:35 guido Exp $
"""
import unittest
from z3locales.i18n.simpletranslationdomain import SimpleTranslationDomain
from z3locales.i18n.tests.test_itranslationdomain import TestITranslationDomain
