...
$Id: test_itranslationdomain.py,v 1.1 2004/11/30 17:33:35 guido Exp $
"""
import unittest
from z3locales.interface.verify import verifyObject
from z3locales.interface import implements

from z3locales.component import getService
...
from z3locales.i18n.interfaces import INegotiator, IUserPreferredLanguages
